import pandas as pd
from models.twovariance_model import twovariance_model
from views.twovariance_view import twovariance_view

class twovariance_controller:
    def __init__(self):
        self.model = twovariance_model()
        self.view = twovariance_view()
    ...
    def generate_twovariance(self, form_data):
        ...
        # REVIEW
        self.view.twovariance(df, subgroups_col, values_col, subgroups)
