class AnovaModel {
  ...
  getSheets(filePath, callback) {
    fetch("http://localhost:5000/anovagetsheets", {
      method: 'POST',
      headers: {
  ...
  getCols(sheet, callback) {
    fetch("http://localhost:5000/anovagetcols", {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json'
      },
  ...
  getSubprocesses(subprocessesCol, callback) {
    fetch("http://localhost:5000/anovagetsubprocesses", {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json'
      },
  ...
  getSubgroups(subgroupsCol, subprocess, callback) {
    fetch("http://localhost:5000/anovagetsubgroups", {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json'
      },
  ...
  submitForm(formData, callback) {
    fetch("http://localhost:5000/anovasubmitform", {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json'
      },
