class TwoVarianceView {
  constructor() {
    // Atributos que armazenam os campos do formulário.
    this._twovarianceFormEl = document.querySelector("#twovariance-form");
    this._fileEl = document.querySelector("#tv-file");
    this._sheetEl = document.querySelector("#tv-sheet");
    this._subprocessesColEl = document.querySelector("#tv-subprocesses-col");
    this._subprocessEl = document.querySelector("#tv-subprocess");
    this._subgroupsColEl = document.querySelector("#tv-subgroups-col");
    this._subgroupsBtnEl = document.querySelector("#tv-subgroups-btn");
    this._subgroupsCheckboxesEl =document.querySelector("#tv-subgroups-checkboxes");
    this._valuesColEl = document.querySelector("#tv-values-col");
    this._submitEl = document.querySelector("#tv-submit");
  }

  /* -------------------------------- setters ------------------------------- */

  set twovarianceFormEl(value) { this._twovarianceFormEl = value; }
  ...
  get twovarianceFormEl() { return this._twovarianceFormEl; }
    ...
    fields.forEach((field, i) => {
      ...
      fieldAllOptions.forEach((col, j) => {
        ...
        if (currentOptionsFiltered.includes(col) && col != currentOptions[i]) {
          ...
          field.remove(j); // REVIEW: verificar se está sendo removido corretamente.
        }
      })
